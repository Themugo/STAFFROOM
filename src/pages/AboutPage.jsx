...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        title={seo?.metaTitle || SEO_CONFIG.pages.about.title}
        description={seo?.metaDescription || SEO_CONFIG.pages.about.description}
        canonical={SEO_CONFIG.pages.about.canonical}
